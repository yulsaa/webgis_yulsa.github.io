...
!(function (e, t) {
  ...
  var $ = {
    on(e, t, s) {
      const a = this;
      if (!a.infoListeners || a.destroyed) return a;
      if ("function" != typeof t) return a;
      const i = s ? "unshift" : "push";
      return (
        e.split(" ").forEach((e) => {
          a.infoListeners[e] || (a.infoListeners[e] = []), a.infoListeners[e][i](t);
        }),
        a
      );
    },
    ...
    onAny(e, t) {
      const s = this;
      if (!s.infoListeners || s.destroyed) return s;
      if ("function" != typeof e) return s;
      const a = t ? "unshift" : "push";
      return s.infoAnyListeners.indexOf(e) < 0 && s.infoAnyListeners[a](e), s;
    },
    offAny(e) {
      const t = this;
      if (!t.infoListeners || t.destroyed) return t;
      if (!t.infoAnyListeners) return t;
      const s = t.infoAnyListeners.indexOf(e);
      return s >= 0 && t.infoAnyListeners.splice(s, 1), t;
    },
    off(e, t) {
      const s = this;
      return !s.infoListeners || s.destroyed
        ? s
        : s.infoListeners
        ? (e.split(" ").forEach((e) => {
            void 0 === t
              ? (s.infoListeners[e] = [])
              : s.infoListeners[e] &&
                s.infoListeners[e].forEach((a, i) => {
                  (a === t || (a.__emitterProxy && a.__emitterProxy === t)) && s.infoListeners[e].splice(i, 1);
                });
          }),
          s)
        : s;
    ...
    emit() {
      const e = this;
      if (!e.infoListeners || e.destroyed) return e;
      if (!e.infoListeners) return e;
      let t, s, a;
      for (var i = arguments.length, r = new Array(i), n = 0; n < i; n++) r[n] = arguments[n];
      "string" == typeof r[0] || Array.isArray(r[0])
        ? ((t = r[0]), (s = r.slice(1, r.length)), (a = e))
        : ((t = r[0].info), (s = r[0].data), (a = r[0].context || e)),
        s.unshift(a);
      return (
        (Array.isArray(t) ? t : t.split(" ")).forEach((t) => {
          e.infoAnyListeners &&
            e.infoAnyListeners.length &&
            e.infoAnyListeners.forEach((e) => {
              e.apply(a, [t, ...s]);
            }),
            e.infoListeners &&
              e.infoListeners[t] &&
              e.infoListeners[t].forEach((e) => {
                e.apply(a, s);
              });
        }),
        e
    ...
    destroy(e, t) {
      ...
      return (
        void 0 === s.params ||
          ...
          s.emit("destroy"),
          Object.keys(s.infoListeners).forEach((e) => {
            s.off(e);
          }),
          !1 !== e &&
            ((s.$el[0].swiper = null),
  ...
  const re = [
    ...
    function (e) {
      ...
      function v(e) {
        ...
        let n = t.$el;
        if (
          ("container" !== t.params.mousewheel.infoTarget && (n = d(t.params.mousewheel.infoTarget)),
      ...
      function w(e) {
        let s = t.$el;
        "container" !== t.params.mousewheel.infoTarget && (s = d(t.params.mousewheel.infoTarget)),
          s[e]("mouseenter", m),
          s[e]("mouseleave", f),
          s[e]("wheel", v);
      }
